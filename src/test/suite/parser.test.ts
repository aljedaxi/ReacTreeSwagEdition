...
describe('Parser Test Suite', () => {
	...
	describe('It should properly count repeat components and consolidate and grab their props', () => {
		...
		test('Grandchild should have the correct three props', () => {
			...
			jestExpect(tree.children[0].children[0].props.prop3).toBe('One ${more.prop} here');
			jestExpect(tree.children[0].children[0].props.prop4).toBe('Why am i ${choices.find} to myself');
		});
	});
